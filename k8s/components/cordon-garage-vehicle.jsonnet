...
local params = std.extVar('__ksonnet/params').components['cordon-garage-vehicle'];
...

{
  ...
  kind: 'FlinkJob',
  metadata: {
    name: 'cordon-garage-vehicle',
    namespace: 'flows',
    labels: {
      app: 'cordon-garage-vehicle',
      version: version,
    },
  },
  spec: {
    ...
    mainClass: 'org.dav.vehicle_rider.CordonAndGarageFlow',
    props: params.props,
  },
}
